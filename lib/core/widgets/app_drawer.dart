    ...
    if (isAdmin) {
      navItems.addAll([
        ...
        _DrawerTile(
          ...
          route: '/admin/events',
          currentRoute: currentRoute,
          onTap: () => _navigate(context, '/admin/events'),
        ),
        _DrawerTile(
          ...
          currentRoute: currentRoute,
          onTap: () => _navigate(context, '/admin/reservations'),
        ),
        _DrawerTile(
      ...
      navItems.addAll([
        ...
        _DrawerTile(
          ...
          route: '/user/events',
          currentRoute: currentRoute,
          onTap: () => _navigate(context, '/user/events'),
        ),
        _DrawerTile(
          icon: Icons.event_available,
          title: 'Reservation',
          ...
          currentRoute: currentRoute,
          onTap: () => _navigate(context, '/user/reservation'),
        ),
        _DrawerTile(
        ...
        _DrawerTile(
          ...
          route: '/user/my-reservations',
          currentRoute: currentRoute,
          onTap: () => _navigate(context, '/user/my-reservations'),
        ),
      ]);
    }
