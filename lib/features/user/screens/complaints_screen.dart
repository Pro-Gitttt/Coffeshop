...
class _ComplaintsScreenState extends State<ComplaintsScreen> {
  ...
  Future<void> _showComplaintDialog(BuildContext context) async {
    // Capture the parent (screen) context so we can safely show/dismiss the
    // loading dialog after the complaint input dialog is closed.
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                // Close the complaint input dialog using its own context.
                Navigator.pop(dialogContext);
                // Show loading dialog using parentContext (still mounted).
                ...
                try {
                  ...
                  if (parentContext.mounted) {
                    Navigator.pop(parentContext); // Ensure loading dialog closed
                    ScaffoldMessenger.of(parentContext).showSnackBar(
                      SnackBar(
                  ...
                  // Safety: if for any reason the loading dialog is still
                  // visible and the context is mounted, attempt dismissal.
                  if (parentContext.mounted) {
                    // Use maybePop to avoid popping the scaffold route if the
  ...
  void _showLoadingDialog(BuildContext context) {
    // Use rootNavigator to ensure dialog is attached to the app-level
    // overlay. Return a lightweight Dialog to avoid layout issues.
    showDialog(
      context: context,
