...
class _ComplaintDetailScreenState extends State<ComplaintDetailScreen> {
  ...
  // Use role-aware route so admin can reuse this screen for replying
  final authUser = context.read<AuthProvider>().currentUser;
  final route = authUser != null && authUser.role.toLowerCase() == 'admin'
        ...
        children: [
          ...
          _MessageInput(
            ...
            onSend: () async {
              ...
              if (user == null) return;
              try {
                final msg = ComplaintMessageModel(
                  id: '',
                ...
                await _firestoreService.createComplaintMessage(msg);
