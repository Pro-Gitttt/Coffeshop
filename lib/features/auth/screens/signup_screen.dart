...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  static const String _serviceId = 'service_ab75res';
  static const String _templateId = 'template_lsx8fp4';
  static const String _publicKey = '3ICQUlxq0LapNCqZh';
  ...
  Future<void> _sendWelcomeEmail(String name, String email) async {
    try {
      ...
      final response = await http.post(
        ...
        body: json.encode({
          ...
          'user_id': _publicKey,
          'template_params': {
            'user_name': name.isNotEmpty ? name : 'Valued User',
            'user_email': email,
          },
        }),
      );
