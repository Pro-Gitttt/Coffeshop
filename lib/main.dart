...
import 'features/user/screens/reservation_screen.dart';
import 'features/user/screens/my_reservations_screen.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/user/events': (context) => const EventsScreen(),
          '/user/reservation': (context) => const ReservationScreen(),
          '/user/my-reservations': (context) => const MyReservationsScreen(),
          ...
          // Reuse the same detail + chat screen for admin replies
          '/admin/complaint-detail': (context) => const ComplaintDetailScreen(),
